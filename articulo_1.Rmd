...
Las cifras que se pueden obtener del sector informal no son tan precisas como las provenientes del sector formal por lo cual el análisis del empleo informal es muy complicado. Debido a ello, en este artículo se realizará un análisis en base a las estadísticas del Registro Estadístico de Empleo en la Seguridad Social (REES), publicado por el  INEC. Esta base de datos guarda información sobre todas las personas registradas en la seguridad social con información sobre sus contratos laborales, lo que permite un análisis preciso y potente sobre la situación del mercado formal en el país. 
